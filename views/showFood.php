                ...
                <div class="form-row">
                    <div class="col-md-4 mb-4">
                        ...
                        <input class="form-control form-special" type="text" name="food_name" placeholder="food name"
                            id="validationTooltip01" required value="<?php echo $food['food'];?>">
                    </div>
                    <div class="col-md-4 mb-4">
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input class="form-control form-special" type="file" name="food_image" placeholder="picture"
                            id="validationTooltip01" style="font-size: 12px;">
                ...
                <div class="form-row">
                    <div class="col-md-3 mb-4">
                        ...
                        <input class="form-control form-special" type="text"
                            ...
                            placeholder="0.00" id="validationTooltip01" required value="<?php echo $food['price'];?>">
                    </div>
                    <div class="col-md-9 mb-4">
                        ...
                        <textarea class="form-control form-special" type="text" name="food_description"
                            placeholder="food description" id="validationTooltip01" required rows="5""><?php echo $food['description'];?></textarea>
				    </div>
				  </div>
